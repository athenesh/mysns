...
-- avatar_url 컬럼 추가 (기존 users 테이블에)
...
CREATE TABLE IF NOT EXISTS public.likes (
    ...
    -- 중복 응원하기 방지 (같은 사용자가 같은 게시물에 여러 번 응원하기 불가)
...
GROUP BY u.id, u.clerk_id, u.name, u.avatar_url;
